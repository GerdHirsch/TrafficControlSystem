...
template <class SUTImplementation> class TrafficLightTest {
public:
  TrafficLightTest()
...
inline void TrafficLightTest<SUTImpl>::testConstructor() {
...
template <class SUTImpl> inline void TrafficLightTest<SUTImpl>::testOff_off() {
  auto &sut = getSUT();
...
template <class SUTImpl>
inline void TrafficLightTest<SUTImpl>::testOff_timerTick() {
  auto &sut = getSUT();
...
template <class SUTImpl>
inline void TrafficLightTest<SUTImpl>::testOff_flash_6_ticks() {
  auto &sut = getSUT();
...
template <class SUTImpl>
inline void TrafficLightTest<SUTImpl>::testFlashing_off() {
  auto &sut = getSUT();
...
template <class SUTImpl>
inline void TrafficLightTest<SUTImpl>::testFlashing_flash() {
  auto &sut = getSUT();
...
template <class SUTImpl>
inline void TrafficLightTest<SUTImpl>::testFlashing_switchOver() {
  auto &sut = getSUT();

  rm.beginInit();
  initFlashing_switchOver();
  rm.endInit();
...
template <class SUTImpl>
inline void TrafficLightTest<SUTImpl>::testOperation_flash_5_ticks() {
  auto &sut = getSUT();
...
template <class SUTImpl>
inline void TrafficLightTest<SUTImpl>::testYellow_5_times_switchOver() {
  auto &sut = getSUT();

  rm.beginInit();
  initYellow_5_times_switchOver();
  rm.endInit();
...
template <class SUTImpl>
inline void TrafficLightTest<SUTImpl>::testOperation_timerTick() {
  auto &sut = getSUT();
...
template <class SUTImpl>
inline void TrafficLightTest<SUTImpl>::testExceptionOperation_off() {
  auto &sut = getSUT();
...
template <class SUTImpl>
inline void TrafficLightTest<SUTImpl>::testExceptionOff_switchOver() {
  auto &sut = getSUT();
