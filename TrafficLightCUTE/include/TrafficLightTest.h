...
template<class SUTImpl>
inline
void TrafficLightTest<SUTImpl>::testOff_timerTick(){
	auto &sut = getSUT();
...
template<class SUTImpl>
inline
void TrafficLightTest<SUTImpl>::testFlashing_switchOver(){
	auto &sut = getSUT();
...
template<class SUTImpl>
inline
void TrafficLightTest<SUTImpl>::testYellow_5_times_switchOver(){
	auto &sut = getSUT();
