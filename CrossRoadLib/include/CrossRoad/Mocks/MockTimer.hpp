...
public:
  MockTimer(ResultManager &resultManager)
      : intervalDuration(IntervalDuration(0)), resultManager(&resultManager) {}
...
inline void MockTimer::add(CR::CrossRoad &crossroad) {
  this->crossRoad = &crossroad;
}
inline void MockTimer::setCallback(CallbackType callback) {
  this->function = callback;
}
inline void MockTimer::setIntervalDuration(IntervalDuration nextInterval) {
...
inline void MockTimer::stopTimer() { resultManager->addString("stopTimer|"); }
